...
const D = decodeURIComponent, E = decodeURIComponent;
...
{
    // TODO investigate when old is set and old.score is not present

    return !old?.score || cur.score.domain > old.score.domain || ( cur.score.domain === old.score.domain && cur.score.path > old.score.path );
}
...
module.exports = class CookieJar
{
    ...
    set( url, cookie_str )
    {
        ...
        // TODO test if it is valid cookiestr
