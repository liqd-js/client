...
module.exports = function Response( response )
{
    ...
    response.on( 'end', () => { response.req.performance.response = Date.now() - response.req.performance.start - response.req.performance.total; response.req.performance.total += response.req.performance.response - response.req.performance.total - response.req.performance.head });
